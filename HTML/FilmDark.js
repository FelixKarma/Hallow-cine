...
function affichageFilmEtSerie() {
    ...
    if (document.location.href.includes("Film")) {
        ...
        for (const film of films) {
            ...
            console.log(document.location.href == `http://127.0.0.1:5500/HTML/FilmDark.html#${changeTitle}`);
            if (document.location.href == `http://127.0.0.1:5500/HTML/FilmDark.html#${changeTitle}` || 
            document.location.href == `http://127.0.0.1:5500/HTML/Film%20light.html#${changeTitle}`) {
